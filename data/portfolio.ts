...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    results: "吻合度达 ≥88%，单人处理效率提升约 2 倍。评测规则迭代后，badcase 分类准确率与标注一致性提升，减少重复性人工复核。",
  ...
  },
  {
    id: "t2v",
    index: "003",
    title: "多模态 T2V 文生视频caption ",
    period: "2025.02-2025.06",
    summary: "针对Prompt质量不稳定、语义对齐度低的问题，通过Prompt优化与系统评测提升训练数据质量。",
    responsibilities:
      "对不同风格整理并迭代Prompt模板，覆盖画面风格、动作描述、场景氛围、镜头语言，每套风格平均经过7轮调整；按评测规范对生成视频进行人工打分，评估画面流畅度、内容匹配度、主体一致性；输出badcase归因报告，反馈优化生成规则。",
    results: "累计完成T2V数据标注与评测8000+条；单次视频生成所需轮次由4.2次降至2.1次，效率提升50%；有效降低数据生产成本。",
    tags: ["T2V", "Prompt优化", "人工评测", "Badcase归因"],
    metrics: [
