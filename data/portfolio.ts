...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    summary: "针对T2V文生视频训练数据中文本描述和视频画面匹配度低，画面连贯性差、场景信息不完整、进行badcase分类整理及标注结果反馈，提升训练数据质量。",
    responsibilities:
      "按标注规范对生成视频进行画面文本一致性、画面流畅度、主体一致性、动态效果、风格一致性等维度的标注，记录不合格样本并按问题类型分类整理，输出 BadCase 归因报告，配合质检复核与问题反馈",
    results: "累计完成美学视频caption 8000+条，标注质检通过率稳定 ≥95%；语义匹配类问题识别准确率由60%提升至 85%，参与并整理badcase，用于后续的复盘和处理同类问题的标注偏差。",
